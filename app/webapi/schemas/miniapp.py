...
class MiniAppSubscriptionPurchasePaymentRequest(MiniAppSubscriptionPurchasePreviewRequest):
    """Request for direct subscription purchase via payment system (bypassing balance)."""
    payment_method: str = Field(..., alias="paymentMethod")
    
    model_config = ConfigDict(populate_by_name=True)


class MiniAppSubscriptionPurchasePaymentResponse(BaseModel):
    """Response for direct subscription purchase payment."""
    success: bool = True
    payment_url: Optional[str] = Field(default=None, alias="paymentUrl")
    ...
    local_payment_id: Optional[int] = Field(default=None, alias="localPaymentId")
    amount_kopeks: Optional[int] = Field(default=None, alias="amountKopeks")
    amount_label: Optional[str] = Field(default=None, alias="amountLabel")
    extra: Dict[str, Any] = Field(default_factory=dict)
